...
C:\Users\$USERNAME\Downloads\Java.exe
Start-Sleep 120

# Install Unifi Controller
Invoke-WebRequest https://dl.ui.com/unifi/7.0.25/UniFi-installer.exe -OutFile C:\Users\$USERNAME\Downloads\UniFi-installer.exe
C:\Users\$USERNAME\Downloads\UniFi-installer.exe
Start-Sleep 120

#Add Unifi Service
java -jar 'C:\Users\$USERNAME\Ubiquiti UniFilib\ace.jar' installsvc
